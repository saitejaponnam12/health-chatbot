"""
Main Orchestrator - Health Chatbot System
Runs all components: chatbot, interactive interface, visualization, and logging
"""
...
from interactive_chatbot import InteractiveChatbot, generate_example_logs
from visualization import ChatbotAnalyzer, generate_comprehensive_analysis
...
def run_full_pipeline():
    ...
    print_header("🏥 HEALTH CHATBOT SYSTEM - FULL PIPELINE")
    
    # Step 1: Generate example conversation logs
    print("\n[Step 1/3] Generating Example Conversation Logs...")
    print("-" * 80)
    generate_example_logs()
    
    # Step 2: Generate comprehensive analysis and visualization
    print("\n[Step 2/3] Generating Performance Analysis & Visualization...")
    print("-" * 80)
    try:
        analysis, responses, qa_analysis = generate_comprehensive_analysis()
    except Exception as e:
        print(f"\n⚠ Visualization generation encountered an issue (may need additional packages):")
        print(f"   {str(e)}")
        print(f"   Continuing with other components...")
    
    # Step 3: Generate interactive demo
    print("\n[Step 3/3] Preparing Interactive Chatbot Demo...")
    print("-" * 80)
    ...
    1. RUN INTERACTIVE CHATBOT:
       python -m interactive_chatbot --mode interactive
    ...
    4. RUN QUICK DEMO:
       python -m health_chatbot
    
    📊 EXPECTED OUTPUTS:
    ✓ Health Q&A Dataset (50 pairs)
    ✓ Conversation Logs (10 examples)
...
def create_readme():
    ...
    readme_content = """# 🏥 Health Chatbot System
...
def main():
    ...
    print_header("🏥 HEALTH CHATBOT SYSTEM INITIALIZATION")
    
    print("""
    This system includes:
    ✓ 50 Health Q&A Pairs (diseases, symptoms, prevention, treatment)
    ✓ TF-IDF + Cosine Similarity Semantic Matching
    ✓ Confidence Scoring with Automatic Fallback
    ✓ Detailed Explanations for Each Response
